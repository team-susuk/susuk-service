    ...
    <td class="text-end">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-action">
                ...
                <li>
                    <a href="{{adminRoute('admin.price-configs.edit',$row->uuid)}}" class="dropdown-item">Edit</a>
                </li>
                @enditcan
                @itcan('delete admin.price-configs')
                <li>
                    <a href="javascript:;" data-toggle="confirmation"
                        ...
                        data-action="{{adminRoute('admin.price-configs.destroy',$row->uuid)}}" data-method="DELETE"
